    ...
    render() {
        return (
            <Container className="App">
                ...
                <Row className="title">
                    <h1 className="heading">Arrival & Departure Procedure </h1>
                </Row>
                <p>
                ...
                <Row className="title">
                    <h1 className="heading">Gun, Tobacco, Alcohol & Illegal Substance </h1>
                </Row>
                <p>
                ...
                <Row className="title">
                    <h1 className="heading">Holidays & Closings</h1>
                </Row>
                <p>
                ...
                <Row className="title">
                    <h1 className="heading">Visitation</h1>
                </Row>
                <p>
                ...
                <Row className="title">
                    <h1 className="heading">Nap/Quiet Time</h1>
                </Row>
                <p>
                ...
                <Row className="title">
                    <h1 className="heading">Meal & Snack Information</h1>
                </Row>
                <p>
                ...
                <Row className="title">
                    <h1 className="heading">Taxes & End of Year Statments</h1>
                </Row>
                <p>
                ...
                <Row className="title">
                    <h1 className="heading">Weather Policy</h1>
                </Row>
                <p>
